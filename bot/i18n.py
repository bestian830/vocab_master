...
"fr": {
        ...
        "stats_today_added": "➕ Ajouté aujourd'hui: {count} (toutes les langues)",
    ...
    "de": {
        ...
        "stats_today_added": '➕ Hinzugefügt heute: {count} (alle Sprachen)',
        "stats_due": '⚡ Due for review: {count}',
    ...
    "es": {
        ...
        "stats_today_added": '➕ Añadidos hoy: {count} (todas las lenguas)',
    ...
    "pt": {
        ...
        "stats_today_added": '➕ Adicionado hoje: {count} (todos os idiomas)',
    ...
    "ru": {
        ...
        "stats_today_added": '➕ Добавлено сегодня: {count} (все языки)',
    ...
    "it": {
        ...
        "stats_today_added": '➕ Aggiunti oggi: {count} (tutti i linguaggi)',
    ...
    "ja": {
        ...
        "stats_today_added": '➕ 今日追加：{count} (すべての言語)',
    ...
    "ko": {
        ...
        "stats_today_added": '➕ 오늘 추가: {count} (모든 언어)',
